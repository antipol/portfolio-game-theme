function openAbout() {
  document.getElementById("about").classList.toggle("content-show");
  document.getElementById("borderAbout").classList.toggle("button-toggle");
}

function openProjects() {
  document.getElementById("projects").classList.toggle("content-show")
  document.getElementById("borderProjects").classList.toggle("button-toggle");
}

function openContact() {
  document.getElementById("contact").classList.toggle("content-show")
  document.getElementById("borderContact").classList.toggle("button-toggle");
  document.getElementById("waterToggle").classList.toggle("water-show");
}
